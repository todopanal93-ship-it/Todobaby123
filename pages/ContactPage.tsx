  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-lg text-gray-600">¡Estamos aquí para ayudarte! Visítanos o contáctanos.</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 items-start">
        <div className="p-8 neomorphic-out">
          ...
          <p className="text-gray-700 mb-2"><strong>Dirección:</strong> {settings.address}</p>
          <p className="text-gray-700 mb-4"><strong>WhatsApp:</strong> <a href={`https://wa.me/${settings.whatsappNumber.replace(/\+/g, '')}`} target="_blank" rel="noopener noreferrer" className="text-[#00E0FF] hover:underline">{settings.whatsappNumber}</a></p>
